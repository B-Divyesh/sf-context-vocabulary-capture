...
const metadata: Record<string, PageMetadata> = {
  ...
  '/privacy': { title: 'Privacy — Keep the Sentence', description: 'Learn what each saved phrase stores and what Keep the Sentence does not send.', path: '/privacy' },
...
function footer() { return html`<footer><p>Save phrases with source sentences. Review them later.</p><p><a href="/privacy" data-route>Privacy</a> · <a href="/terms" data-route>Terms</a> · Built by Param Factory · v1.0.0</p></footer>`; }
